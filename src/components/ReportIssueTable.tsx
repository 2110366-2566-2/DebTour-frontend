...
export default function ReportIssueTable({reload, setReload}: { reload: boolean, setReload: any }) {
            ...
            reloading ? <div>Loading...</div> :
                <div>
                    <Table>
                        ...
                        >
                            <ReportIssueDetailDisplay reload={reload} setReload={setReload} key={selectedIssue.issueId + "display"} issue={selectedIssue} setSelectedIssue={setSelectedIssue}/>
                        </Dialog>
                    </Table>
                </div>
