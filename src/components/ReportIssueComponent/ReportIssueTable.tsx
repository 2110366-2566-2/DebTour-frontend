    ...
    async function get() {
      ...
      for (let i = 0; i < res.data.length; i++) {
        ...
        temp.push({
          ...
          resolverAdminId:
            res.data[i].resolverAdminId !== null
              ? res.data[i].resolverAdminId
              : 0,
          resolveMessage:
            res.data[i].resolveMessage !== null
              ? res.data[i].resolveMessage
              : "",
      ...
      {reloading ? (
        ...
        <div>
          <Table>
                ...
                issues.map((issue) => (
                  ...
                  >
                    ...
                    <TableCell className="w-[120px] text-xs">
                      {issue.reportTimestamp}
                    </TableCell>
                    <TableCell className="w-[120px] text-xs">
                      {issue.resolveTimestamp}
                    </TableCell>
                  </TableRow>
                ))
              ) : (
            ...
            >
              <ReportIssueDetailDisplay
                reload={reload}
                setReload={setReload}
                key={selectedIssue.issueId + "display"}
                issue={selectedIssue}
